...
router.get('/active',validation(schema.getAllSubCategoriesActiveByCategorySchema) , asyncHandler(subCategoriesController.getAllSubCategoriesActiveByCategory));
router.get('/:id', validation(schema.getSubCategoryByIdSchema) , asyncHandler(subCategoriesController.getSubCategoryById));
